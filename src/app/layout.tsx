...
export const metadata: Metadata = {
  title: "Pancho - Premium E-commerce Products",
  description: "Shop premium Pancho products online. Curated collection of high-quality items with fast shipping and exceptional customer service.",
  keywords: "pancho, products, e-commerce, shopping, premium quality",
  metadataBase: new URL("https://pancho.com"),
  alternates: {
    canonical: "https://pancho.com"
  },
  openGraph: {
    title: "Pancho - Premium E-commerce Products",
    description: "Discover our carefully selected range of premium items perfect for any occasion.",
    siteName: "Pancho",
    type: "website"
  },
  twitter: {
    ...
    title: "Pancho - Premium E-commerce Products",
    description: "Shop premium Pancho products online with fast shipping."
  },
  robots: {
    index: true,
    follow: true
